...
<div class="container" style="margin-top: 90px;">
	<div class="row">
		...
		<?php endif;?>
		<div class="col-lg-12">
			<h3 class="text-white">Modifer numero de telephone</h3>
			<hr>
		</div>
        </div>
        <div class="row">
		<div class="col-lg-12">
			<form method="post" action="<?php echo base_url();?>index.php?page/numberchange">
				<div class="">
					<?php echo get_phrase('Numéro actuel');?> 
				</div>
                <br>
				<div class="text-white"  style="">
					<?php echo $this->crud_model->get_current_user_detail()->number;?>
				</div>
				<br>
				<div class="text-white">Nouveau_numéro </div>
				<div class="text-white">
					<input type="number" name="new_number" style="padding: 10px; width:40%;" />
				</div>
                <br>
				<div class="">

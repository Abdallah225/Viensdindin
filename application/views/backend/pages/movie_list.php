...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Liste des films</h4>
				<table id="basic-datatable" class="table dt-responsive nowrap" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td style="vertical-align: middle;">
								<a href="<?php echo base_url();?>index.php?page/playmovie/<?php echo $row['movie_id'];?>"
								...
								Modifier</a>
								<a href="<?php echo base_url();?>index.php?admin/movie_delete/<?php echo $row['movie_id'];?>" class="btn btn-danger btn-xs btn-mini" onclick="return confirm('Vous-le vous supprimer ce film?')">
								Supprimer</a>
							</td>
						</tr>
						<?php endforeach;?>

...
<div class="row justify-content-center">
    <div class="col-xl-8 col-lg-9 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Liste des acteurs</h4>
					...
					<tbody>
						...
						<tr>
							...
							<td style="vertical-align: middle;">
								...
								Modifier</a>
								<a href="<?php echo base_url();?>index.php?admin/actor_delete/<?php echo $row['actor_id'];?>" class="btn btn-danger btn-xs btn-mini" onclick="return confirm('Vous-le vous supprimer cet acteur?')">
								Suprimer</a>
							</td>
						</tr>
						<?php endforeach;?>
